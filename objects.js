...
//------------>>>> books IS THE  ARRAY && everything inside {} is the OBJECT<<<-------//
 ...
 */
//let myAuthor = "Michael Cevallos";
//createBook("TITLE of the Most Awesome Book");

function createBook(title, author){
    let authorArray = author.split(' '); // returns --->>> ["Michael", "Cevallos"];
    let bookObject = {
        title: title,
        author: {
...
console.log( createBook("The Bible", "IDK"));


console.log("---->>LAST EXAMPLE<----")
 let book2 = [
 createBook("The Bible", "IDK"),
 createBook("Harry Potter", "J.K. Rollin"),
